...
{
	CGFlipDown::CGFlipDown() :CGstEnsenssial()
	{
	...
	CGFlipDown::~CGFlipDown()
	{
		delete m_param;
	}

	void CGFlipDown::GstTell(const std::vector<sAction> &r, sGesture &g)
	{
		DataRecieve(r, g);
	...
	bool CGFlipDown::DistanceConfirm(const SHANDGST &data, sGesture &g)
	{
	...
	bool CGFlipDown::SpeedConfirm(const SHANDGST &data, sGesture &g)
	{
	...
	void CGFlipDown::SetFlipParam(const sGestureParamFlip *gc)
	{
	...
	sGestureParamFlip*	CGFlipDown::GetFlipParam()
	{
		return m_param;
	}

	void CGFlipDown::ResetCtn()
	{
		m_gstout.gtype = DualHand;
// 		m_gstout.pos.x = 0.0;
// 		m_gstout.pos.y = 0.0;
...
// 		m_gstout.fScreenPivot.y = 0.0;
	...
	void CGFlipDown::GestureOut(sGesture &g)
	{
		g = m_gstout;
	}
}