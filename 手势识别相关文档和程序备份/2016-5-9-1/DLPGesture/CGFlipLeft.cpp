...
{
	CGFlipLeft::CGFlipLeft() :CGstEnsenssial()
	{
	...
	CGFlipLeft::~CGFlipLeft()
	{
		delete m_param;
	}

	void CGFlipLeft::GstTell(const std::vector<sAction> &r, sGesture &g)
	{
		DataRecieve(r, g);
	...
	bool CGFlipLeft::DistanceConfirm(const SHANDGST &data, sGesture &g)
	{
	...
	bool CGFlipLeft::SpeedConfirm(const SHANDGST &data, sGesture &g)
	{
	...
	void CGFlipLeft::SetFlipParam(const sGestureParamFlip *gc)
	{
	...
	sGestureParamFlip*	CGFlipLeft::GetFlipParam()
	{
		return m_param;
	}

	void CGFlipLeft::ResetCtn()
	{
		m_gstout.gtype = DualHand;
// 		m_gstout.pos.x = 0.0;
// 		m_gstout.pos.y = 0.0;
...
// 		m_gstout.fScreenPivot.y = 0.0;
	...
	void CGFlipLeft::GestureOut(sGesture &g)
	{
		g = m_gstout;
	}
}