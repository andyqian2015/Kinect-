...
/*#ifdef DEBUG*/
	...
	vMarkPixelPos[0] = nvmath::Vec3f(150, 305, 1177);
	vMarkPixelPos[1] = nvmath::Vec3f(444, 309, 1142);
	vMarkPixelPos[2] = nvmath::Vec3f(376, 251, 1768);
	vMarkPixelPos[3] = nvmath::Vec3f(194, 251, 1803);
/*#endif*/
