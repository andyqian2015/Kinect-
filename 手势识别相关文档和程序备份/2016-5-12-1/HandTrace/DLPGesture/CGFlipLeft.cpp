...
namespace GestureEng
{
	...
	void CGFlipLeft::GstTell(sAction r, sGesture &g)
	{
		DataRecieve(r, g);
	...
	bool CGFlipLeft::DistanceConfirm(SHANDGST data, sGesture &g)
	{
	...
	bool CGFlipLeft::SpeedConfirm(SHANDGST data, sGesture &g)
	{
