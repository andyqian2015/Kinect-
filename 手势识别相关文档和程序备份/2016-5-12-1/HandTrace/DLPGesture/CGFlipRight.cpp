...
namespace GestureEng
{
	...
	void CGFlipRight::GstTell(sAction r, sGesture &g)
	{
		DataRecieve(r, g);
	...
	bool CGFlipRight::DistanceConfirm(SHANDGST data, sGesture &g)
	{
	...
	bool CGFlipRight::SpeedConfirm(SHANDGST data, sGesture &g)
	{
