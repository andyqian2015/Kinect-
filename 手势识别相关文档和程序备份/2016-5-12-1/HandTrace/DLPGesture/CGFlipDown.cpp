...
namespace GestureEng
{
	...
	void CGFlipDown::GstTell(sAction r, sGesture &g)
	{
		DataRecieve(r, g);
	...
	bool CGFlipDown::DistanceConfirm(SHANDGST data, sGesture &g)
	{
	...
	bool CGFlipDown::SpeedConfirm(SHANDGST data, sGesture &g)
	{
