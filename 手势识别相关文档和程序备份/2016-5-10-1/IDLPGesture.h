...
//		void SetKinectInStallMode(eInstallMode InstallMode);
	...
	//合成手势发送的接口//
	__interface __declspec(uuid("{5607829D-8298-4A71-A2E6-EE389EE4B364}")) ISendSynGesture : public IDLPUnknown
	{
		BOOL OnGesture(std::vector<sGesture> s);
	};
	typedef NSINSIVE_PTR::intrusive_ptr<ISendSynGesture> PISendSynGesture;
