...
namespace GestureEng
{
	...
	void CGZooming::GstTell(const std::vector<sAction> &r, sGesture &g)
	{
		DataRecieve(r, g);
...
// 	}
	...
	void CGZooming::ZoomOrRot(const SHANDGST &data1, const SHANDGST &data2, sGesture &g)
	{
	...
	double CGZooming::Angle(const SHANDGST &data1, const SHANDGST &data2)
	{
		double a;
	...
	long double CGZooming::Distance(const SHANDGST &data1, const SHANDGST &data2)
	{
		long double a;
	...
	COORD3 CGZooming::CentrePoint(const SHANDGST &data1, const SHANDGST &data2)
	{
		COORD3 p;
