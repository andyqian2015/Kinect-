...
namespace GestureEng
{
	...
	void CGFlipUp::GstTell(const std::vector<sAction> &r, sGesture &g)
	{
		DataRecieve(r, g);
	...
	bool CGFlipUp::DistanceConfirm(const SHANDGST &data, sGesture &g)
	{
	...
	bool CGFlipUp::SpeedConfirm(const SHANDGST &data, sGesture &g)
	{
